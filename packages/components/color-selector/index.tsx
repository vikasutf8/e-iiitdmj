                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            field.onChange(
                                                isSelected
                                                    ? selected.filter((c: string) => c !== color)   // remove
                                                    : [...selected, color]                           // add
                                            );
                                        }}
                                        className={`w-7 h-7 rounded-md my-1 flex items-center cursor-pointer justify-center border-2 transition 
                  ${isSelected ? "scale-100 border-white" : "border-transparent"}
                  ${isLightColor ? "border-gray-600" : ""}`}
                                        style={{ backgroundColor: color }}
                                    />
                                );
                            ...
                            <button
                                ...
                                className="w-8 h-8 flex items-center justify-center rounded-full border-2 border-gray-500 cursor-pointer bg-slate-700 hover:bg-slate-600 transition"
                            >
                                <PlusIcon size={16} className="text-white" />
                            </button>
                            ...
                            {showColorPicker && (
                                <div className="relative flex items-center gap-2">
                                    <input
                                        ...
                                        value={newColor}
                                        onChange={(e) => setNewColor(e.target.value)}
                                        className="w-10 h-10 p-0 rounded-md bg-slate-700 cursor-pointer"
                                    />
